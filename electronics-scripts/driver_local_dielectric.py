...
back into reattempting failures, capped by --max-retries.
...
def status_path(struct_dir: Path) -> Path:
    return struct_dir / "dielectric" / "dielectric_result.json"
...
def main():
    ...
    ap.add_argument("--force", action="store_true",
                     help="ignore existing dielectric_result.json and rerun anyway, "
